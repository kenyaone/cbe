...
class LinkFormFourVideosSimplifiedSeeder extends Seeder
{
    public function run()
    {
        ...
        if (!is_dir($basePath)) {
            $this->command->error("Form Four content directory not found");
            return;
        }
        ...
        // Get all subjects in Form Four
        $subjects = \App\Models\LearningArea::where('grade_level', 'Form Four')->get();
        ...
        $this->command->info("Linked $videoCount Form Four videos as lessons and $pdfCount PDFs");
    }
