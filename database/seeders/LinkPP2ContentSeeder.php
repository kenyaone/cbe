...
class LinkPP2ContentSeeder extends Seeder
{
    public function run()
    {
        $storagePath = '/home/tele/cbe-platform/storage/app/media/PP2';

        if (!is_dir($storagePath)) {
            $this->command->error("PP2 content not found at {$storagePath}");
            return;
        }
        ...
        $this->command->info("✓ Created: $created PP2 content files");
