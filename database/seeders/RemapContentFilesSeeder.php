...
class RemapContentFilesSeeder extends Seeder
{
    ...
    private function getFileMappings()
    {
        return [
            ...
            'Grade Eight' => [
                'English' => [
                    'tense, mood, advanced, complex, sentence' => 'Complex sentences',
                    'noun, nouns, singular, plural, pronoun, pronoun' => 'Advanced grammar',
                    'verb, verbs, action, auxiliary, tense' => 'Advanced grammar',
                    'adjective, adverb, stylistic, device' => 'Stylistic devices',
                    'punctuation, comma, semicolon, colon' => 'Complex sentences',
                    'comprehension, reading, understand, analysis, evaluate, interpret, critical' => 'Analysis',
                    'vocabulary, word, vocabulary, idiomatic' => 'Word usage',
                    'composition, essay, paragraph, creative, persuasive, technical' => 'Composition',
                    'speaking, presentation, debate, discussion, oral' => 'Speaking and Listening',
                    'listening, listen, comprehend, discussion' => 'Speaking and Listening',
                ],
                'Mathematics' => [
                    'ratio, proportion, rate' => 'Ratios and proportions',
                    'percentage, percent' => 'Percentages and rates',
                    'index, indices, root, square, cube' => 'Indices and roots',
                    'real number' => 'Real numbers',
                    'density, mass, volume' => 'Mass and density',
                    'surface area, lateral' => 'Area and surface area',
                    'triangle, polygon, properties' => 'Triangles and polygons',
                    'circle, radius, diameter, circumference, arc' => 'Circles',
                    'transformation, rotation, reflection, translation' => 'Transformations',
                    'quadratic, quadratic' => 'Quadratic equations',
                    'simultaneous, linear system' => 'Simultaneous equations',
                    'inequality, linear inequality' => 'Inequalities',
                    'distance time, speed, motion' => 'Time and speed',
                    'length, metre, centimetre, kilometer, measurement' => 'Length and distance',
                    'area, perimeter' => 'Area and surface area',
                    'volume, capacity, cubic' => 'Volume',
                    'angle, angles, degree' => 'Angles and lines',
                    'shape, 2d, 3d, dimension' => '3D shapes',
                    'data, statistics, frequency, distribution' => 'Data collection and analysis',
                    'mean, median, mode, average' => 'Measures of central tendency',
                    'probability, outcome' => 'Probability',
                ],
                'Integrated Science' => [
                    'research, method, experimentation, experiment, procedure' => 'Experimentation',
                    'data, analysis, result, conclusion' => 'Data analysis',
                    'report, scientific writing' => 'Reporting',
                    'reaction, chemical, element, compound, bonding' => 'Chemistry',
                    'acid, base, indicator, ph' => 'Acids and bases',
                    'matter, property, physical, chemical' => 'Matter and reactions',
                    'cell, biology, genetic, evolution' => 'Biology',
                    'ecosystem, ecology, organism, environment' => 'Ecology',
                    'force, motion, mechanical, mechanics' => 'Mechanics',
                    'energy, wave, sound, optics, light' => 'Energy',
                    'electricity, magnetic, magnetism, electromagnetism' => 'Electricity and magnetism',
                    'wave, sound, frequency, wavelength' => 'Waves and sound',
                ],
            ],
            'Grade Seven' => [
                'English' => [
