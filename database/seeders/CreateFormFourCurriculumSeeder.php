...
class CreateFormFourCurriculumSeeder extends Seeder
{
    public function run()
    {
        ...
        foreach ($subjects as $subjectData) {
            $order++;
            $code = 'F4' . str_pad($order, 2, '0', STR_PAD_LEFT);
        ...
        $this->command->info('Form Four curriculum created successfully with ' . count($subjects) . ' subjects');
    }
}
